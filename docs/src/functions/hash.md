...
Cryptographic and checksum hash functions.
...
| [`hmac_md5`](#hmac_md5) | `string, string -> string` | Calculate HMAC-MD5 signature |
| [`hmac_sha1`](#hmac_sha1) | `string, string -> string` | Calculate HMAC-SHA1 signature |
| [`hmac_sha256`](#hmac_sha256) | `string, string -> string` | Calculate HMAC-SHA256 signature |
| [`hmac_sha512`](#hmac_sha512) | `string, string -> string` | Calculate HMAC-SHA512 signature |
