...
Portable file-path manipulation functions.
...
|----------|-----------|-------------|
| [`path_basename`](#path_basename) | `string -> string` | Get filename from path |
| [`path_dirname`](#path_dirname) | `string -> string` | Get directory from path |
| [`path_ext`](#path_ext) | `string -> string` | Get file extension |
| [`path_is_absolute`](#path_is_absolute) | `string -> boolean` | Check if path is absolute |
| [`path_is_relative`](#path_is_relative) | `string -> boolean` | Check if path is relative |
| [`path_join`](#path_join) | `string... -> string` | Join path segments |
| [`path_stem`](#path_stem) | `string -> string` | Get filename without extension |
