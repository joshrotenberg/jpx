...
jpx extends JMESPath with 470+ additional functions for strings, math, dates, hashing, encoding, regex, and more. See the [jpx-functions skill](../jpx-functions/SKILL.md) for details.
